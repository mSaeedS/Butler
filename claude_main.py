...
def send_data(ball=None, hexapod=None, obstacle=None, coordinates=None):
    ball = ball or (33,60)
    hexapod = hexapod or (43,65)
    obstacle = obstacle or (12, 43)
...
frame_count = 0
frame_rate = 10  # Send data every 10 frames
...
while True:
    ...
    # Send data every 'frame_rate' frames
    frame_count += 1
